    ...
    <>
      ...
      <Transition appear show={showModal} as={Fragment}>
        <Dialog
          ...
          onClose={closeModal}
        >
          <div className="w-full flex flex-col sm:rounded-2xl sm:border border-neutral-200 dark:border-neutral-700 space-y-8 px-0">
...
//       Clear data
//     </button>
//     <ButtonPrimary href={"/pay-done"}>Delete</ButtonPrimary>
//   </div>
// </div>;