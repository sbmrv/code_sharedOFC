...
const NavigationItem: FC<NavigationItemWithRouterProps> = ({
  ...
  // const PropertyDataDemo = authContext.propertyData as any;
  ...
  const renderDropdownMenuNavlink = (item: NavItemType) => {
    ...
    const deleteProperty = async () => {
      ...
      try {
        const response = await axios.get(
          `${API_URL}/property/delete-property?propId=${propertyID}`,
          {
            headers: {
              token: token,
            },
    ...
    if (item.name == "delete Property") {
      // return <button onClick={deleteProperty} >Delete Property</button>;
      return (
        <>
          <ModalSelectGuests
            renderChildren={() => (
          ...
          >
            ...
            <DialogActions>
              ...
              <ButtonPrimary onClick={deleteProperty}>Delete</ButtonPrimary>
            </DialogActions>{" "}
          </Dialog>
        </>
      );
